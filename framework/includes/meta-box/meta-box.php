<?php
if( !class_exists('Smarket_Meta_Box') && class_exists('RW_Meta_Box')){
    class Smarket_Meta_Box extends RW_Meta_Box {
        /**
        ...
        public static function enqueue_admin_assets() {
            global $post;
            wp_enqueue_style( 'smarket-metabox', get_template_directory_uri() . '/framework/includes/meta-box/assets/css/meta-box.min.css' );
            wp_enqueue_script( 'smarket-metabox', trailingslashit ( get_template_directory_uri() ). 'framework/includes/meta-box/assets/js/meta-box.min.js', array( 'jquery' ), '2.4', true );
        }
        /**
            ...
            if ( isset( $this->validation ) && $this->validation ) {
				...
				if ( typeof rwmb == "undefined" )
				{
					var rwmb = {
						...
						summaryMessage : "' , esc_js( esc_html__( 'Please correct the errors highlighted below and try again.', 'smarket' ) ) , '"
					};
				}
				else
				{
